		...
		>
			...
			>
				<slot>
					...
					<rotatePlane v-if="styleLoadingType === 'rotatePlane'" :color="'#F88F6A'" :size="size" />
...
export default {
	...
	data() {
		return {
			...
			styleLoadingIsOpen: this.$mStore.state.styleLoadingIsOpen,
			styleLoadingType: this.$mStore.state.styleLoadingType,
			themeColor:this.$mStore.state.themeColor,
		};
	},
	watch: {
		active(value) {
