// import {CityList} from '../../utils/adress/pca.js';
...
Component({
  ...
  methods: {
    ...
    // 初始化选择器信息
    togglePicker() {
      let { value, mode, codes, show, cityArr } = this.data
    ...
    changeCityPicker(e) {
      ...
      let { citys, areas, value, mode, cityArr } = this.data
    ...
    // 确认
    submitCityPicker() {
      const { cityArr, citys, areas, value, mode, idkey, namekey } = this.data
